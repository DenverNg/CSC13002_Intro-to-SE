    ...
    >
      {["dashboard", "report", "transactions"].includes(state) && (
        <>
          <Transaction
            ...
            chatSearchFillSubtract={state === "transactions" ? "/img/subtract-1.svg" : undefined}
            chatSearchFillSubtractClassName={state === "transactions" ? "!h-[30px] !w-[33px]" : undefined}
            chatSearchFillVector={state === "transactions" ? "/img/vector-231.svg" : undefined}
          ...
          <Report
            ...
            img={state === "report" ? "/img/subtract-6.svg" : undefined}
            reportClassName={
              state === "report" ? "!text-2xl ![white-space:unset] !left-[43px] !w-[169px] !top-[5px]" : undefined
            }
            stateProp={state === "report" ? "selected" : "default"}
            subtract={reportSubtract}
            subtractClassName={state === "report" ? "!h-9 !w-7" : undefined}
          />
          <Dashboard
            chartFill={state === "dashboard" ? "/img/chart-fill.svg" : undefined}
            chartFillClassName={state === "dashboard" ? "!h-10 !w-10" : undefined}
            chartFillSubtract={["report", "transactions"].includes(state) ? "/img/subtract-7.svg" : undefined}
            className={
              state === "dashboard"
          ...
          <div className="w-[173px] left-[57px] top-[61px] h-[250px] absolute">
            <div className="w-[159px] -left-0.5 -top-px h-52 absolute">
              ...
              <img
                ...
                alt="Logo"
                src={state === "report" ? "/img/logo-3.png" : logo}
              />
            </div>
      ...
      {state === "setting" && (
        <div className="relative w-[309px] h-[1080px]">
          ...
          />
          <Dashboard
            chartFillSubtract="/img/subtract-11.svg"
...
MenuAsset.propTypes = {
  ...
  reportSubtract: PropTypes.string,

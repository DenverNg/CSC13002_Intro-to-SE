...
export const KhungNhPNgYBO = ({
  ...
  return (
    ...
    >
      <div className={`h-[98px] relative ${overlapGroupClassName}`}>
        {["default", "variant-3"].includes(state.property1) && (
          <>
            ...
            />
            <div
              className={`[font-family:'Inter',Helvetica] w-[243px] left-[147px] tracking-[0] text-[38.3px] top-[35px] text-[#7065d2] font-semibold leading-[normal] absolute ${
        ...
        {["variant-2", "variant-4"].includes(state.property1) && (
          <>
            ...
            <div className="[font-family:'Inter',Helvetica] w-[243px] left-[147px] italic tracking-[0] text-[38.3px] opacity-[0.46] top-[35px] text-[#7065d2] font-medium leading-[normal] absolute">
              dd/mm/yyyy
            </div>
            <div className="[background:linear-gradient(180deg,rgb(238,236,255)_0%,rgb(255,255,255)_100%)] w-[246px] left-[22px] top-0 blur-[11.1px] h-9 absolute" />
            <div className="[font-family:'Inter',Helvetica] w-[255px] left-[35px] tracking-[0] text-[23.3px] top-px text-[#5645eb] font-semibold leading-[28.2px] absolute">
              Nhập ngày báo cáo
            </div>
            <div
              className={`[font-family:'Inter',Helvetica] left-[133px] tracking-[0] text-[38.3px] top-[35px] text-[#5645eb] font-normal leading-[normal] absolute ${

...
export const MenuAsset = ({ state, className, logo = "/img/logo-3.png" }) => {
  return (
    <div
    ...
    >
      {["dashboard", "report", "transactions"].includes(state) && (
        <>
          ...
          />
          <Dashboard
            chartFill={state === "report" ? "/img/chart-fill.svg" : undefined}
          ...
          <Setting
            ...
            settingFill={state === "report" ? "/img/setting-fill.svg" : undefined}
            stateProp="default"
          />
        </>
      )}
      ...
      {state === "setting" && (
        <div className="relative w-[309px] h-[1080px]">
          ...
          <Report
            ...
            to="/report-frame-u45-daily-report"
          />

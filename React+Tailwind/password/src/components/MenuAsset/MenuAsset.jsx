    ...
    >
      {["dashboard", "report", "transactions"].includes(state) && (
        <>
          ...
          <Report
            ...
            img={state === "report" ? "/img/subtract-9.svg" : undefined}
            reportClassName={
              state === "report" ? "!text-2xl ![white-space:unset] !left-[43px] !w-[169px] !top-[5px]" : undefined
            }
            stateProp={state === "report" ? "selected" : "default"}
            subtract={["dashboard", "transactions"].includes(state) ? "/img/subtract-20.svg" : undefined}
          ...
          <div className="w-[173px] left-[57px] top-[61px] h-[250px] absolute">
            <div className="w-[159px] -left-0.5 -top-px h-52 absolute">
              ...
              <img
                ...
                alt="Logo"
                src={state === "report" ? "/img/logo-3.png" : "/img/logo-1.png"}
              />
            </div>
          ...
          <Setting
            className="!absolute !left-16 !top-[704px]"
            settingFillSubtract="/img/subtract-11.svg"
            stateProp="default"
            to="/setting-frame"
          />
        </>
      ...
      {state === "setting" && (
        <div className="relative w-[309px] h-[1080px]">
          <img className="absolute w-[286px] h-[1080px] top-0 left-0" alt="Menu" src={menu} />
          <Transaction
            chatSearchFill={transactionChatSearchFill}
            className="!absolute !left-16 !top-[527px]"
            stateProp="default"
          />
          <Report
            ...
            stateProp="default"
            subtract="/img/subtract-12.svg"
            subtractClassName="!h-[29px] !w-[23px]"
          />
          <Dashboard
            chartFill={dashboardChartFill}
            className="!absolute !left-[60px] !top-[435px]"
            stateProp="default"
          />
          <div className="absolute w-[173px] h-[250px] top-[61px] left-[57px]">
            <div className="absolute w-[159px] h-52 -top-px -left-0.5">
              ...
              <img className="absolute w-[159px] h-[170px] top-0 left-0 object-cover" alt="Logo" src={logo} />
            </div>
          ...
          <Setting
            ...
            settingFill={settingSettingFill}
            settingFillClassName="!h-[43px] !left-[-3px] !w-[43px]"
            stateProp="selected"
          />
        </div>
      )}
...
MenuAsset.propTypes = {
  ...
  transactionChatSearchFill: PropTypes.string,

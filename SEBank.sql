...
BEGIN
	...
	IF DATEDIFF(DAY, @NGAYMOSO ,GETDATE()) < (SELECT GIATRI FROM DONVI_TOITHIEU WHERE TEN = 'THOIGIAN')
		BEGIN
...
EXEC MOSOTIETKIEM 0,N'DUY','0123123','aAC','18/07/2024',1000000
EXEC MOSOTIETKIEM 0,N'nghia','523123','aC','18/07/2024',1000000
EXEC LAPPHIEUGUI 'MS000000', 0, '18/07/2024',200000
EXEC LAPPHIEUGUI 'MS000001', 1, '18/07/2024',500000

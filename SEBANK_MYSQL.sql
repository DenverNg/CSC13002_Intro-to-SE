...
CREATE PROCEDURE BAOCAO_THANG(IN THANG INT, IN TENKYHAN VARCHAR(50))
BEGIN
...
--TEST
CALL MOSOTIETKIEM(3, 'Nguyễn Ngọc Mạnh Cường', '1234', 'aBC', '2024-08-22', 1000000);
...
CALL BAOCAO_THANG(10, "Kỳ hạn 3 tháng")
